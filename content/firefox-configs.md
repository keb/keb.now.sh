...
Consult [userchrome.org](https://www.userchrome.org/) for more details about CSS configurations.

My Firefox custom settings:
...
#tabbrowser-tabs { --tab-min-height: 31px !important; }
